<?php
include  '/volume1/web/DAO/Carga_factura_proveedor.php';
/*
...
//            echo "Metodo enviar_pila() peso de pila=".count($Pila); 
           $carga=new Carga_factura_proveedor();                               
...
//              echo "TERMINA EJECUCION DE PILA"        ;
    ...
    private function On()
    {
            $archivo_estado=fopen("/usr/CFDI/Factura_Proveedor/pila.txt", "r+");    
...
//            echo "PILA APAGADA";
    ...
    private function espera()
    {
        ...
        while($espera!=10)
            {
                if(!fopen("/usr/CFDI/Factura_Proveedor/pila.txt", "r+"))
                {
                    sleep(5);
                    $espera++;
                }
